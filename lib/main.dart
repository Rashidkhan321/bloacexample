...
import 'package:bloacexample/ui/conunter_example.dart';
import 'package:bloacexample/ui/example2.dart';
import 'package:bloacexample/ui/imagess.dart';
import 'package:bloacexample/utls/imagesgetter.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

import 'bloc/imagesgetter/image_pic_event.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_)=>
          bloclass(),child: BlocProvider(
  create: (context) =>switchblo(),
  child: BlocProvider(
  create: (context) => silderblo(),
  child: BlocProvider(
  create: (context) => imageblo(imagegetter()),
  child: MaterialApp(
      title: 'Flutter Demo',
      theme: ThemeData(
